...
public sealed class EmailTemplateRenderer : IEmailTemplateRenderer
{
    ...
    public EmailMessage BuildVerifyEmailMessage(Guid userId, string email, string userName, string token)
    {
        ...
        string confirmUrl = BuildConfirmationUrl(options.VerifyEmailBaseUrl, userId, encodedToken);
    ...
    private static string BuildConfirmationUrl(string baseUrl, Guid userId, string encodedToken)
    {
